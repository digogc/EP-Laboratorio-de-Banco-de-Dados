using RestaurantesBD.AbasForms;
using RestaurantesBD.AbasForms.Funcionarios;
using RestaurantesBD.AbasForms.Restaurantes;
...
namespace RestaurantesBD
{
    public partial class Frm_Menu : Form
    {
        ...
        private void DisableButton()
        {
            if (currentBtn != null)
            {
                currentBtn.BackColor = Color.FromArgb(70, 70, 70);
        ...
        private void Btn_Campus_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new Frm_Campus());
        }

        private void Btn_Restaurantes_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color2);
            OpenChildForm(new Frm_Restaurantes());
        }

        private void Btn_Funcionarios_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color3);
            OpenChildForm(new Frm_Funcionarios());
        }
